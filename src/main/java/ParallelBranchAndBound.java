...
//####[214]####
    private static volatile Method __pt__startWorker_int_method = null;//####[214]####
    private synchronized static void __pt__startWorker_int_ensureMethodVarSet() {//####[214]####
        if (__pt__startWorker_int_method == null) {//####[214]####
            try {//####[214]####
                __pt__startWorker_int_method = ParaTaskHelper.getDeclaredMethod(new ParaTaskHelper.ClassGetter().getCurrentClass(), "__pt__startWorker", new Class[] {//####[214]####
                    int.class//####[214]####
                });//####[214]####
	 ...
	 *///####[214]####
    private TaskID<Void> startWorker(int id) {//####[214]####
        //-- execute asynchronously by enqueuing onto the taskpool//####[214]####
        return startWorker(id, new TaskInfo());//####[214]####
    }//####[214]####
    /**
	 * Starts a new worker (on a new core) to process the state tree
	 * 
	 * @param id the id of the worker
	 *///####[214]####
    private TaskID<Void> startWorker(int id, TaskInfo taskinfo) {//####[214]####
        // ensure Method variable is set//####[214]####
        if (__pt__startWorker_int_method == null) {//####[214]####
            __pt__startWorker_int_ensureMethodVarSet();//####[214]####
        }//####[214]####
        taskinfo.setParameters(id);//####[214]####
        taskinfo.setMethod(__pt__startWorker_int_method);//####[214]####
        taskinfo.setInstance(this);//####[214]####
	 ...
	 * @param id the id of the worker
	 *///####[214]####
    private TaskID<Void> startWorker(TaskID<Integer> id) {//####[214]####
        //-- execute asynchronously by enqueuing onto the taskpool//####[214]####
        return startWorker(id, new TaskInfo());//####[214]####
    }//####[214]####
    /**
	 ...
	 * @param id the id of the worker
	 *///####[214]####
    private TaskID<Void> startWorker(TaskID<Integer> id, TaskInfo taskinfo) {//####[214]####
        // ensure Method variable is set//####[214]####
        if (__pt__startWorker_int_method == null) {//####[214]####
            __pt__startWorker_int_ensureMethodVarSet();//####[214]####
        }//####[214]####
        taskinfo.setTaskIdArgIndexes(0);//####[214]####
        taskinfo.addDependsOn(id);//####[214]####
        taskinfo.setParameters(id);//####[214]####
        taskinfo.setMethod(__pt__startWorker_int_method);//####[214]####
        taskinfo.setInstance(this);//####[214]####
        return TaskpoolFactory.getTaskpool().enqueue(taskinfo);//####[214]####
	 ...
	 * @param id the id of the worker
	 *///####[214]####
    private TaskID<Void> startWorker(BlockingQueue<Integer> id) {//####[214]####
        //-- execute asynchronously by enqueuing onto the taskpool//####[214]####
        return startWorker(id, new TaskInfo());//####[214]####
    }//####[214]####
    /**
	 ...
	 * @param id the id of the worker
	 *///####[214]####
    private TaskID<Void> startWorker(BlockingQueue<Integer> id, TaskInfo taskinfo) {//####[214]####
        // ensure Method variable is set//####[214]####
        if (__pt__startWorker_int_method == null) {//####[214]####
            __pt__startWorker_int_ensureMethodVarSet();//####[214]####
        }//####[214]####
	 ...
	 * @param id the id of the worker
	 *///####[214]####
    public void __pt__startWorker(int id) {//####[214]####
        new Worker(id).run();//####[215]####
    }//####[216]####
//####[216]####
}//####[216]####
