...
public class GraphTest {
	...
	@Test
	public void test_Nodes_11_2_Proccessors_Parallel() throws IOException {
	...
	@Test
	public void test_Nodes_7_2_Proccessors_Parallel() throws IOException {
		Schedule solution = new ParallelBranchAndBound(2).schedule(new TaskGraph("src/test/resources/Nodes_7_OutTree.dot", 2));
		assertEquals(28, solution.getTotalTime());
	} 
	
	@Test
	public void test_9middle_ForkandJoin_2_Proccessors_Parallel() throws IOException {
